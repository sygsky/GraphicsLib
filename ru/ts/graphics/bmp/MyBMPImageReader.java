 ...
 */
public class MyBMPImageReader extends ImageReader implements BMPConstants
{
	// BMP Image types
	...
	/**
	 * Constructs <code>MyBMPImageReader</code> from the provided
	 * <code>ImageReaderSpi</code>.
	 */
	public MyBMPImageReader( ImageReaderSpi originator )
	{
		super( originator );
	}
		...
		throws IOException
	{
		...
		iis.seek( bitmapOffset ); //++ Sygsky at 07-MAR-2014: to allow reading second time
